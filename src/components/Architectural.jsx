export function BlueprintGrid({ color = '#F5F1EA', opacity = 0.08 }) {
  return (
    ...
    >
      ...
      {/* Coordinates */}
      <text x="70" y="48" fill={color} fontSize="8" fontFamily="Helvetica Neue" letterSpacing="2">N 48.51</text>
      <text x="1300" y="48" fill={color} fontSize="8" fontFamily="Helvetica Neue" letterSpacing="2">E 9.13</text>
      {/* Dimension tick */}
      ...
      <text x="715" y="894" fill={color} fontSize="7" fontFamily="Helvetica Neue" letterSpacing="2" textAnchor="middle">1200 mm</text>
    </svg>
  );
}
