  ...
  return (
    ...
    >
      ...
      <g>
        ...
        {/* Coordinates */}
        <text x="44" y="33" fill={color} fontSize="7" fontFamily="Helvetica Neue" letterSpacing="2">N 48.51°</text>
      </g>
      <g>
        {/* TR */}
        <text fill={color} fontSize="7" fontFamily="Helvetica Neue" letterSpacing="2" textAnchor="end">
