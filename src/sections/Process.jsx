        ...
        <div style={{
          ...
          <div>
            <p style={{ fontSize:'9px', letterSpacing:'0.3em', textTransform:'uppercase',
              color:'#B8963E', marginBottom:'24px', fontFamily:'"Helvetica Neue", Helvetica, Arial, sans-serif',
          ...
          <FadeUp key={s.phase} delay={i * 0.1}>
            ...
            >
              ...
              <div style={{ fontSize:'9px', letterSpacing:'0.22em', textTransform:'uppercase',
                color:'#B8963E', marginBottom:'20px', fontFamily:'"Helvetica Neue", Helvetica, Arial, sans-serif',
