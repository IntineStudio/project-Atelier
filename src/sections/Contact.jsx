...
const inputStyle = {
  ...
  fontFamily: '"Helvetica Neue", Helvetica, Arial, sans-serif', fontSize: '14px', fontWeight: 300,
      ...
      <div style={{
        ...
        <FadeUp>
          <p style={{ fontSize:'9px', letterSpacing:'0.3em', textTransform:'uppercase',
            color:'#B8963E', marginBottom:'36px', fontFamily:'"Helvetica Neue", Helvetica, Arial, sans-serif',
            ...
            <div style={{ marginTop:'40px', display:'flex',
              ...
              <motion.button
                style={{
                  ...
                  fontFamily:'"Helvetica Neue", Helvetica, Arial, sans-serif', fontSize:'10px', letterSpacing:'0.22em',
