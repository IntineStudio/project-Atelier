  ...
  return (
    ...
    >
      ...
      >
        ...
        <text x="52" y="40" fill="#F5F1EA" fontSize="7.5" fontFamily="Helvetica Neue" letterSpacing="2">N 48.51°</text>
      </svg>
      ...
      >
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '7px' }}>
          ...
          <span style={{
            ...
            fontFamily: '"Helvetica Neue", Helvetica, Arial, sans-serif', fontWeight: 300,
          }}>
            Scroll
          </span>
        </div>
